...
const Contact = () => {
  ...
  const handlesubmit = (e) => {
    ...
    emailjs.send(
      ...
      {
        from_name: form.name,
        to_name: "VIshwas Prabhu",
        from_email: form.email,
        to_email: "vishwas.19cs118@sode-edu.in",
  ...
  return (
    <section className="relative flex lg:flex-row flex-col max-container">
      ...
      <div className="flex-1 min-w-[50%] flex flex-col">
        ...
        <form className="w-full flex flex-col gap-7 mt-14" onSubmit={handlesubmit} ref={formRef}>
          ...
          <label className="text-black-500 font-semibold">Your Message
            <textarea name="message" rows={4} className="input" placeholder="Let me how I can help you!" required value={form.message}
              onChange={handleChange} onFocus={handleFocus} onBlur={handleBlur}
            />
          </label>
      ...
      <div className="lg:w-1/2 w-full lg:h-auto md:h-[50%] h-[350px]">
        <Canvas
          camera={{
            position: [0, 0, 5],
            fov: 75,
